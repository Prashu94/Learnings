# -*- coding: utf-8 -*-
"""
Created on Sat Sep 22 21:05:51 2018
...
#Predicting for multiple observation at once
logistic_regr1.predict(x_test[0:10])

predictions = logistic_regr1.predict(x_test_PCA)
...
logistic_regr2 = LogisticRegression(solver = 'lbfgs')
logistic_regr2.fit(x_train_LDA,y_train)

logistic_regr2.predict(x_test_LDA[0].reshape(1,-1))

#Predicting for multiple observation at once

predictions2 = logistic_regr2.predict(x_test_LDA)

"""
Measuring the performance
"""
score2 = logistic_regr2.score(x_test_LDA,y_test)
print(score2)
